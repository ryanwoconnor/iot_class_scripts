...
import requests   # NEED TO DENOTE PACKAGES NEEDED
import socket
import configparser
import os
import sys
...
class AtlasI2C:
	...
	def read(self, num_of_bytes=31):
		...
		if res[0] == 1: 
			...
			jsonDict = {'host': str(socket.gethostname()), 'event': 'metric', 'index': index, 'fields':{'Conductivity':str(value),'_value':str(value),'metric_name':'Conductivity'}}
...
def main():
	...
	device.set_i2c_address(AtlasI2C.default_address)
